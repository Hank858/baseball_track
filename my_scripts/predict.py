...
# model_path = './model/ball_tracking_v3-YOLOv11.pt' # 可以偵測到本壘板
# model_path = './model/glove_tracking_v4_YOLOv11.pt' # 可以偵測到本壘板
model_path = '../ultralytics/runs/detect/freeze_10_fulltracking/weights/best.pt' # 替換成你的模型路徑
...
# results = model.predict(source=source_video, save=True, conf=0.1)
# results = model.track(source=source_video, show=True, tracker="bytetrack.yaml") # 物件追蹤(bytetrack)
# results = model.track(source=source_video, show=True)  # 物件追蹤(BoT-SORT)
